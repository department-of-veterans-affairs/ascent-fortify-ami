...
aws s3api --region us-gov-west-1 get-object --bucket fortify-utility --key HPE_Security_Fortify_17.20_Server_WAR_Tomcat.zip  Fortify.zip
...
sudo cp Fortify/ssc.war /opt/tomcat/apache-tomcat-8.5.31/webapps/
...
sudo mv /home/ec2-user/setenv.sh /opt/tomcat/apache-tomcat-8.5.31/bin/
sudo chmod 755 /opt/tomcat/apache-tomcat-8.5.31/bin/setenv.sh
...
aws s3api --region us-gov-west-1 get-object --bucket fortify-utility --key HP_Fortify_Process_Seed_Bundle-2017_Q3.zip HP_Fortify_Process_Seed_Bundle-2017_Q3.zip
aws s3api --region us-gov-west-1 get-object --bucket fortify-utility --key HP_Fortify_Report_Seed_Bundle-2017_Q3.zip HP_Fortify_Report_Seed_Bundle-2017_Q3.zip
